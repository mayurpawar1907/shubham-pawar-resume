      ...
      <div className="min-h-screen overflow-y-scroll bg-[#0f0f1b] text-white font-sans p-4 md:p-8">
        ...
        >
          ...
          >
            ...
            {/* Resume Button */}
            <motion.a
              href="/Shubham_Patil_CV.pdf"
              download
              target="_blank"
              rel="noopener noreferrer"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-cyan-400 text-black font-semibold px-6 py-2 rounded-full hover:bg-cyan-300 transition inline-block cursor-pointer"
            >
              Download CV
            </motion.a>
          </motion.div>
